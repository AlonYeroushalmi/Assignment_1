...
putc(int fd, char c)
{
 ...
 63b:	b8 28 00 00 00       	mov    $0x28,%eax
        ...
        if(s == 0)
          s = "(null)";
 640:	bb e7 07 00 00       	mov    $0x7e7,%ebx
...
free(void *ap)
{
 ...
 6ca:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6cd:	a3 10 0b 00 00       	mov    %eax,0xb10
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 77c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 77f:	89 15 10 0b 00 00    	mov    %edx,0xb10
      return (void*)(p + 1);
 ...
 794:	eb e9                	jmp    77f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 796:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 79d:	0b 00 00 
 7a0:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 7a7:	0b 00 00 
    base.s.size = 0;
 7aa:	b8 14 0b 00 00       	mov    $0xb14,%eax
 7af:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 7b6:	00 00 00 
