...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45f:	f7 f6                	div    %esi
 461:	0f b6 92 1c 08 00 00 	movzbl 0x81c(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 65b:	b8 28 00 00 00       	mov    $0x28,%eax
        ...
        if(s == 0)
          s = "(null)";
 660:	bb 13 08 00 00       	mov    $0x813,%ebx
...
free(void *ap)
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 44 0b 00 00       	mov    %eax,0xb44
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 44 0b 00 00       	mov    %eax,0xb44
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 44 0b 00 00    	mov    0xb44,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 74f:	76 3f                	jbe    790 <malloc+0x90>
    ...
    if(p == freep)
 751:	39 05 44 0b 00 00    	cmp    %eax,0xb44
 ...
 776:	e8 f5 fe ff ff       	call   670 <free>
  return freep;
 77b:	8b 15 44 0b 00 00    	mov    0xb44,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 7b4:	eb e9                	jmp    79f <malloc+0x9f>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7b6:	c7 05 44 0b 00 00 48 	movl   $0xb48,0xb44
 7bd:	0b 00 00 
 7c0:	c7 05 48 0b 00 00 48 	movl   $0xb48,0xb48
 7c7:	0b 00 00 
    base.s.size = 0;
 7ca:	b8 48 0b 00 00       	mov    $0xb48,%eax
 7cf:	c7 05 4c 0b 00 00 00 	movl   $0x0,0xb4c
 7d6:	00 00 00 
