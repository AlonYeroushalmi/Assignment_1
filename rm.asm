...
printint(int fd, int xx, int base, int sgn)
{
 ...
 46f:	f7 f6                	div    %esi
 471:	0f b6 92 24 08 00 00 	movzbl 0x824(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 5e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 5eb:	b8 1d 08 00 00       	mov    $0x81d,%eax
...
free(void *ap)
{
 ...
 6c7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 6c9:	a3 4c 0b 00 00       	mov    %eax,0xb4c
}
 6ce:	5b                   	pop    %ebx
 6cf:	5e                   	pop    %esi
 6d0:	5f                   	pop    %edi
 ...
 6ea:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 6ed:	a3 4c 0b 00 00       	mov    %eax,0xb4c
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 709:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 70c:	8b 15 4c 0b 00 00    	mov    0xb4c,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 7ac:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 7af:	89 15 4c 0b 00 00    	mov    %edx,0xb4c
      return (void*)(p + 1);
 ...
 7c4:	eb e9                	jmp    7af <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 7c6:	c7 05 4c 0b 00 00 50 	movl   $0xb50,0xb4c
 7cd:	0b 00 00 
 7d0:	c7 05 50 0b 00 00 50 	movl   $0xb50,0xb50
 7d7:	0b 00 00 
    base.s.size = 0;
 7da:	b8 50 0b 00 00       	mov    $0xb50,%eax
 7df:	c7 05 54 0b 00 00 00 	movl   $0x0,0xb54
 7e6:	00 00 00 
